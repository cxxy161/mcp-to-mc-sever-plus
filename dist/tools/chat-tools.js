import { z } from "zod";
export function registerChatTools(factory, getBot, messageStore) {
    factory.registerTool("send-chat", "Send a chat message in-game", {
    ...
    factory.registerTool("read-chat", "Get recent chat messages from players", {
