...
function createCancellableFlightOperation(bot, destination, controller) {
...
export function registerFlightTools(factory, getBot) {
    factory.registerTool("fly-to", "Make the bot fly to a specific position", {
        ...
        try {
            ...
            if (controller.signal.aborted) {
                ...
                return factory.createErrorResponse(`Flight timed out after ${FLIGHT_TIMEOUT_MS / 1000} seconds. The destination may be unreachable. ` +
